...
resource "google_iam_workload_identity_pool_provider" "github" {
  ...
  attribute_condition = "assertion.repository == \"sunaba-log/podcast-ui\""
...
resource "google_service_account_iam_member" "deployer_wif" {
  ...
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.name}/attribute.repository/sunaba-log/podcast-ui"
}
